...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.buttonBox.setGeometry(QtCore.QRect(130, 540, 341, 32))
        self.buttonBox.setOrientation(QtCore.Qt.Horizontal)
        self.buttonBox.setStandardButtons(QtWidgets.QDialogButtonBox.Cancel|QtWidgets.QDialogButtonBox.Ok)
        self.buttonBox.setObjectName("buttonBox")
        self.checkBox_muestreo_natural = QtWidgets.QCheckBox(Dialog)
        self.checkBox_muestreo_natural.setGeometry(QtCore.QRect(20, 460, 131, 20))
        self.checkBox_muestreo_natural.setObjectName("checkBox_muestreo_natural")
        self.checkBox_muestreo_instantaneo = QtWidgets.QCheckBox(Dialog)
        self.checkBox_muestreo_instantaneo.setGeometry(QtCore.QRect(20, 490, 151, 20))
        self.checkBox_muestreo_instantaneo.setObjectName("checkBox_muestreo_instantaneo")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.checkBox_muestreo_natural.setText(_translate("Dialog", "Muestreo Natural"))
        self.checkBox_muestreo_instantaneo.setText(_translate("Dialog", "Muestreo Instantaneo"))
        self.subtitulo_3.setText(_translate("Dialog", "Puede obviar estos parametros si asi lo desea"))
